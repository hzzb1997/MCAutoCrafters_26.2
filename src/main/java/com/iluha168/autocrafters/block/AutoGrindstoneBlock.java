...
public class AutoGrindstoneBlock extends BaseAutoBlock {
    public static final Identifier ID = Identifier.fromNamespaceAndPath(ServerMod.modId, "autogrindstone");
    ...
    public static final Block BLOCK = Registry.register(
        ...
        BLOCK_KEY,
        new AutoGrindstoneBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CRAFTER).setId(BLOCK_KEY))
    );
    ...
    public AutoGrindstoneBlock(Properties settings){
        super(settings);
    }
